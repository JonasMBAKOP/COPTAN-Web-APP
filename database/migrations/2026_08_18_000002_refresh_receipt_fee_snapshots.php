...
return new class extends Migration
{
    ...
    {
        // This is a one-time data alignment. The previous snapshots cannot be
        // reconstructed safely after other fee changes, so do not overwrite
        // them automatically on rollback.
    }
};
