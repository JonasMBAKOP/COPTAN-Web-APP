...
<head>
    ...
    <title>@yield('title', 'COPTAN') — GESCOP</title>
...
<body class="h-full overflow-hidden bg-gray-50" x-data>
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 flex flex-col min-w-0 min-h-0 overflow-hidden lg:ml-0">
            ...
            {{-- Contenu de la page --}}
            <main @class([
                'flex-1 py-4 lg:py-6 overflow-y-auto overflow-x-hidden',
                'px-1 lg:px-2' => request()->routeIs('infirmary.*'),
                'px-4 lg:px-6' => ! request()->routeIs('infirmary.*'),
            ])>
                {{-- Messages flash --}}
                @if(session('success'))
