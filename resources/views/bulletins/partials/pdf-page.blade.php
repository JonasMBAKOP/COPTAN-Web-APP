...
<style>
    ...
    .bulletin-page .cert-official-header { margin-bottom: 4px; padding-bottom: 2px; }
    .bulletin-page .cert-official-header__columns { grid-template-columns: 1fr 34mm 1fr; gap: 3mm; }
    .bulletin-page .cert-official-header__republic { font-size: 9.5px; line-height: .98; }
    .bulletin-page .cert-official-header__motto { font-size: 8px; line-height: .98; margin: .5px 0; }
    .bulletin-page .cert-official-header__stars { font-size: 9px; line-height: .9; margin: 0; letter-spacing: .5px; }
    .bulletin-page .cert-official-header__ministry { font-size: 8.5px; line-height: .98; }
    .bulletin-page .cert-official-header__school { font-size: 9.5px; line-height: .98; }
    .bulletin-page .cert-official-header__meta,
    .bulletin-page .cert-official-header__email { font-size: 7.5px; line-height: 1; }
    .bulletin-page .cert-official-header__email span { font-size: 8px; }
    .bulletin-page .cert-official-header__logo img,
    .bulletin-page .cert-official-header__logo-placeholder { width: 22mm !important; height: 22mm !important; }
    .bulletin-page .cert-official-header__logo-placeholder { font-size: 20px; }
    .bulletin-page .cert-official-header__title { margin-top: 4px; padding: 4px 6px; font-size: 14px; line-height: 1.05; }
    .bulletin-page .coptan-appreciations > div:first-child {
        font-size: 6.5px !important; line-height: 1.05; margin-bottom: 3px !important;
        padding-top: 0 !important; border-top: none !important;
    }
    .bulletin-page .coptan-appreciations .appr-codes-row {
        display: grid; grid-template-columns: repeat(6, minmax(0, 1fr));
        margin-bottom: 0; width: 100%;
    }
    .bulletin-page .coptan-appreciations .appr-code-cell { padding: 3px 2px; min-width: 0; }
    .bulletin-page .coptan-appreciations .appr-code-cell:nth-child(-n+3) {
        grid-column: span 2; border-bottom: 1px solid #CBD5E1;
    }
    .bulletin-page .coptan-appreciations .appr-code-cell:nth-child(n+4) { grid-column: span 3; }
    .bulletin-page .coptan-appreciations .appr-code-cell .code { font-size: 7.5px; }
    .bulletin-page .coptan-appreciations .appr-code-cell .meaning { font-size: 5.2px; line-height: 1.05; }
    .bulletin-page .coptan-stats-primary .stat-metric {
        display: flex; justify-content: space-between; align-items: baseline;
    }
    .bulletin-page .coptan-stats-primary .stat-value {
        border: 1px solid var(--bleu); padding: 1px 4px; border-radius: 2px; white-space: nowrap;
    }
    .bulletin-page .coptan-stats-primary .stat-metric > span:last-child {
        border: 1px solid var(--bleu); padding: 1px 4px; border-radius: 2px; white-space: nowrap;
    }
    ...
    .bulletin-page .coptan-bottom-grid span[style*="color: #374151"],
    .bulletin-page .coptan-bottom-grid span[style*="color: #1A3A6B"],
    .bulletin-page .signatures-row > div > div[style*="color: #1A3A6B"] {
        color: #030712 !important;
    }
    .bulletin-page .coptan-bottom-grid span[style*="color: #9CA3AF"],
    .bulletin-page .signatures-row span[style*="color:#9CA3AF"] {
        color: #111827 !important;
    }
    ...
    .bulletin-page .coptan-bottom-grid .stat-value,
    .bulletin-page .coptan-bottom-grid .stat-value > span {
    ...
    .bulletin-page .coptan-appreciations > div:first-child span {
    ...
    .bulletin-page .coptan-bottom-grid { grid-template-columns: 1.05fr 1.4fr 1.05fr !important; }
    .bulletin-page .coptan-stats-primary { grid-column: 1; grid-row: 1; }
...
<div class="bulletin-page">
    ...
    <table style="width: 100%; border-collapse: collapse; border: none; background: transparent; margin-bottom: 6px;">
        ...
        <tr>
            ...
            <td style="width: 82px; padding: 0 10px 0 0; vertical-align: middle; border: none; text-align: center;">
                ...
                @else
                    <div style="width: 72px; height: 76px; border: 1px solid #D1D5DB; color: #111827; display: flex; align-items: center; justify-content: center; background: #E5E7EB; border-radius: 4px;">
                        <svg width="48" height="48" viewBox="0 0 24 24" fill="#111827" aria-label="Avatar élève"><circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 3.6-7 8-7s8 3 8 7H4z"/></svg>
                    </div>
                @endif
            </td>
            {{-- Info columns --}}
    ...
    @endphp
    <div class="coptan-bottom-grid" style="display: grid; grid-template-columns: 1.05fr 1.05fr 1.4fr; gap: 6px; margin-top: 3px; margin-bottom: 6px; align-items: stretch;">
    <div class="stats-row coptan-stats" style="display: contents;">
        {{-- Bloc 1: Moyenne, Rang, Moy. de Classe --}}
        <div class="coptan-stats-primary" style="border: 1px solid #CBD5E1; border-radius: 4px; padding: 5px 7px; background: #F8FAFC; display: flex; flex-direction: column; gap: 3px; font-size: 7.5px;">
        ...
        <div class="coptan-stats-secondary" style="border: 1px solid #CBD5E1; border-radius: 4px; padding: 5px 7px; background: #F8FAFC; display: flex; flex-direction: column; gap: 3px; font-size: 7.5px;">
            <div style="display: flex; justify-content: space-between; align-items: baseline;">
    ...
    <div class="coptan-appreciations" style="margin-top: 0; min-width: 0; align-self: stretch;">
        <div style="text-align:center; font-size:7.5px; font-weight:900; text-transform:uppercase; letter-spacing:.06em; color:#1A3A6B; margin-bottom:4px; border-top: 1px solid #CBD5E1; padding-top:4px;">
            ...
            <table class="conduct-table">
                <thead>
                    <tr>
                        ...
                        <th>NON JUSTIFIÉES / UNJUSTIFIED</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
    ...
    <div class="signatures-row" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; border-top: 1px dashed #D1D5DB; padding-top: 1px; margin-top: 0;">
        ...
        <div style="text-align: center; font-size: 7.5px;">
            ...
            <div class="authority-seal" style="height: 18mm; display: flex; align-items: center; justify-content: center; margin-top: 1mm;">
                @if($sealSrc)
                    <img src="{{ $sealSrc }}" alt="Cachet du principal" style="max-width: 30mm; max-height: 16mm; object-fit: contain;">
                @else
                    <svg width="82" height="42" viewBox="0 0 82 42" role="img" aria-label="Emplacement du cachet du principal">
