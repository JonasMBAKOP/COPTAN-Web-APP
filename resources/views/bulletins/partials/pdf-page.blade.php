...
<style>
    ...
    .bulletin-page .cert-official-header { margin-bottom: 6px; padding-bottom: 4px; }
    .bulletin-page .cert-official-header__columns { grid-template-columns: 1fr 34mm 1fr; gap: 4mm; }
    .bulletin-page .cert-official-header__republic { font-size: 9.5px; line-height: 1.05; }
    .bulletin-page .cert-official-header__motto { font-size: 8px; line-height: 1.05; margin: 2px 0; }
    .bulletin-page .cert-official-header__stars { font-size: 9px; line-height: 1; margin: 1px 0; letter-spacing: .5px; }
    .bulletin-page .cert-official-header__ministry { font-size: 8.5px; line-height: 1.05; }
    .bulletin-page .cert-official-header__school { font-size: 9.5px; line-height: 1.05; }
    .bulletin-page .cert-official-header__meta,
    .bulletin-page .cert-official-header__email { font-size: 7.5px; line-height: 1.15; }
    .bulletin-page .cert-official-header__email span { font-size: 8px; }
    .bulletin-page .cert-official-header__logo img,
    .bulletin-page .cert-official-header__logo-placeholder { width: 26mm !important; height: 26mm !important; }
