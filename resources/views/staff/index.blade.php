...
<div x-data="{ viewMode: 'grid' }">
    ...
    <div class="mb-6 flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
        <div>
            ...
            {{-- Stats Row --}}
            <div class="flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-gray-500 mb-0 font-medium">
        ...
        <form method="GET" action="{{ route('staff.lists.print') }}" target="_blank" class="flex flex-wrap items-center gap-2">
            <label for="staff-list-type" class="sr-only">Type de liste</label>
