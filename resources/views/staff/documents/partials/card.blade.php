@php
    ...
    $primaryPhone = isset($phones)
        ...
        : null;
    $schoolPhone = $primaryPhone?->number ?? null;
...
<div class="id-card" style="border-color:#1A3A6B;">
        ...
        <div class="id-card__body">
            ...
            <div class="id-card__photo-section">
                <div class="id-card__photo-box">
                    @if($staff->photo)
                        <img src="{{ asset('storage/' . $staff->photo) }}" alt="" class="id-card__photo">
                    @else
                        <div class="id-card__photo-placeholder">
                            {{ strtoupper(substr($staff->last_name ?? $staff->first_name ?? '', 0, 1) . substr($staff->first_name ?? '', 0, 1)) }}
                        </div>
                    @endif
                </div>
                {{-- <div class="id-card__matricule">MATRICULE: {{ $staff->employee_number ?? '—' }}</div> --}}
            </div>
            ...
            <div class="id-card__info-section">
                <table class="id-card__info-table">
                    <tr class="id-card__info-row">
                        ...
                        <td class="id-card__info-value">{{ strtoupper($staff->last_name ?? '') }}</td>
                    </tr>
                    <tr class="id-card__info-row">
                        <td class="id-card__info-label">
                    ...
                    <tr class="id-card__info-row">
                        <td class="id-card__info-label">
                            ...
                            <span class="id-card__label-en">Subject(s)</span>
                        </td>
                    ...
                    <tr class="id-card__info-row">
                        <td class="id-card__info-label">
                            ...
                            <span class="id-card__label-en">Phone</span>
                        </td>
                        <td class="id-card__info-value">{{ $staff->phone ?? '—' }}</td>
                    </tr>
                    <tr class="id-card__info-row">
                        <td class="id-card__info-label">
                            <span class="id-card__label-fr">Email</span>
                            <span class="id-card__label-en">Email</span>
                        </td>
                        <td class="id-card__info-value">{{ $staff->email ?? '—' }}</td>
                    </tr>
                </table>
                ...
                <div class="id-card__top-logo">
                    ...
                    @endif
                    @if($schoolPhone)
                        <div class="id-card__top-logo-meta">{{ $schoolPhone }}</div>
                    @endif
                </div>
