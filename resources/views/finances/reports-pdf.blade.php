...
body { font-family: Arial, sans-serif; font-size:10px; color:#050E1F; }

.header { background:#0B2545; color:#fff; padding:10px 14px;
...
.section-title { background:#1A3A6B; color:#fff; padding:5px 10px;
                 font-size:9px; font-weight:900; text-transform:uppercase;
                 letter-spacing:1px; margin:10px 0 6px; border-radius:3px; }
